...
RSpec.describe MilestonesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: milestone.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      milestone = Milestone.create! valid_attributes
      get :edit, params: {id: milestone.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Milestone" do
        expect {
          post :create, params: {milestone: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {milestone: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested milestone" do
        milestone = Milestone.create! valid_attributes
        put :update, params: {id: milestone.to_param, milestone: new_attributes}, session: valid_session
        milestone.reload
      ...
      it "redirects to the milestone" do
        milestone = Milestone.create! valid_attributes
        put :update, params: {id: milestone.to_param, milestone: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        milestone = Milestone.create! valid_attributes
        put :update, params: {id: milestone.to_param, milestone: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested milestone" do
      milestone = Milestone.create! valid_attributes
      expect {
        delete :destroy, params: {id: milestone.to_param}, session: valid_session
      }.to change(Milestone, :count).by(-1)
    end
